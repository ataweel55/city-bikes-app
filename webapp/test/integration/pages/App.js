sap.ui.require(
  ...
  function(
    ...
    var sViewName = 'com.sovanta.city_bikes.view.App';
            ...
            return this.waitFor({
              ...
              matchers: [
                new PropertyStrictEquals({
                  ...
                  value:
                    iNumberItemsLeft +
                    (iNumberItemsLeft === 1 ? ' item left' : ' items left')
                })
              ],
              success: function() {
          ...
          iShouldSeeItemCount: function(iItemCount) {
            return this.waitFor({
              ...
              success: function() {
                Opa5.assert.ok(
                  true,
                  'The table has ' + iItemCount + ' item(s)'
                );
              },
              errorMessage:
                "List does not have expected number of items '" +
                iItemCount +
                "'."
            });
          }
