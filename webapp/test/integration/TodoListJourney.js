...
sap.ui.define(
  ...
  function(opaTest) {
    ...
    opaTest('should add an item', function(Given, When, Then) {
      ...
      // Assertions
      Then.onTheAppPage
        .iShouldSeeTheItemBeingAdded(3, 'my test')
        .and.iTeardownTheApp();
    });
    ...
    opaTest('should remove a completed item', function(Given, When, Then) {
      ...
      // Assertions
      Then.onTheAppPage
        .iShouldSeeAllButOneItemBeingRemoved('my test')
        .and.iTeardownTheApp();
    });
    ...
    opaTest('should select an item', function(Given, When, Then) {
      ...
      // Assertions
      Then.onTheAppPage
        .iShouldSeeTheLastItemBeingCompleted(true)
        .and.iTeardownTheApp();
    });
    ...
    opaTest('should unselect an item', function(Given, When, Then) {
      ...
      // Assertions
      Then.onTheAppPage
        .iShouldSeeTheLastItemBeingCompleted(false)
        .and.iTeardownTheApp();
    });

    opaTest('should show correct count for completed items', function(
      Given,
      When,
      Then
    ) {
      ...
      // Assertions
      Then.onTheAppPage.iShouldSeeItemLeftCount(1).and.iTeardownTheApp();
    });
  }
);
